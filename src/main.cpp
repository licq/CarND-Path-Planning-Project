            ...
            if (event ==
              ...
              if (too_close) {
                ...
                for (int i = 0; i < lane_offsets.size(); i++) {
                  bool is_safe = true;
                  int target_lane = lane + lane_offsets[i];
              ...
              for (int i = 0; i < 3; i++) {
                double new_car_s = car_s + (i + 1) * 30;
                double new_car_d = 2 + 4 * lane;

                vector<double> next_wp = getXY(new_car_s, new_car_d, map_waypoints_s, map_waypoints_x,
                                               map_waypoints_y);
